...
export default function SearchByCountry(props) {
  const {
    register,
    handleSubmit,
    formState: { errors },
  ...
  const onSubmit = data => {
    if (data) {
      onSubmitData(data.searchbycountry);
    }
  };
  return (
      ...
      <div className="row col-md-12  d-flex justify-content-end mb-3">
        <div className="col-md-4 ">
          <div className="form-group">
            <input className="form-control" placeholder="Search by country(ae,ar,at,au,be,bg,br,ca,ch,cn,co,cu,cz,de,eg,es,fr..)" {...register('searchbycountry')} />
          </div>
        </div>
        <div className="col-md-4 ">
